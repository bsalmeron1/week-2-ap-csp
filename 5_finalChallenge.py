...
num1 = input("What is your favorite food to eat when you are sad? : ")
animal = input("What is your meanest family member? ")
print(f"{animal}{num1} is the best beer brand")
